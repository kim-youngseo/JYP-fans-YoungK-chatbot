...
# 화면 UI 설정
st.set_page_config(page_title="DAY6 YoungK🦊 채팅방", page_icon="🎤", layout="centered")
st.markdown("""
    <style>
    body {
...
st.markdown("DAY6 YoungK🦊 채팅방")
st.markdown("<p>YoungK와 함께 대화해보세요💬</p>", unsafe_allow_html=True)
...
with st.form("message_form", clear_on_submit=True):
    user_input = st.text_input("🔻 팬 메시지를 입력해주세요:", key="input", label_visibility="collapsed")
    submitted = st.form_submit_button("YoungK🦊의 답장 받기")
